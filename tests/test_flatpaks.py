...
""",
        ...
        self.assertIn("appdata_target=\"/out/files/share/appdata/$app_id.appdata.xml\"", containerfile)
        self.assertIn("if [ \"$appdata_source\" != \"$appdata_target\" ]; then", containerfile)
        self.assertIn("cp -a \"$appdata_source\" \"$appdata_target\"", containerfile)
